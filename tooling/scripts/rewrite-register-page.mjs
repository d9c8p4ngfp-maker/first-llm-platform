...
const content = String.raw`import { useEffect, useState } from 'react'
...
const target = 'D:/first/first-gateway-web/src/pages/auth/RegisterPage.tsx'
...
fs.writeFileSync(target, decodeUnicodeEscapes(content), 'utf8')
