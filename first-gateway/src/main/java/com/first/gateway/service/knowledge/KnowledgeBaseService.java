...
public class KnowledgeBaseService {
    ...
    public KnowledgeBaseService(KnowledgeBaseRepository knowledgeBaseRepository,
                                ...
                                @Lazy KnowledgeIndexService knowledgeIndexService,
    ...
    private void triggerIndex(Long kbId, Long userId, KnowledgeDocument doc) {
        if (aiServiceProperties.isRag() && aiServiceClient.isHealthy()) {
            knowledgeIndexService.indexDocumentAsync(kbId, doc, userId);
        }
    }
}